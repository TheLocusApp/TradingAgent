        ...
        if not self.position:
            ...
            if squeeze_cond:
                if (current_close > bb_upper_val and 
                    ...
                    stop_loss_price = entry_price - (2 * atr_val)
                    risk_amount = entry_price - stop_loss_price
                    
                    if risk_amount <= 0:
                        print(f"🌙 MOON DEV DEBUG: Invalid risk calculation for long - Entry: {entry_price}, SL: {stop_loss_price}")
                        return
                    ...
                    if position_size > 0:
                        print(f"🌙 MOON DEV LONG ENTRY: Price: {entry_price:.2f}, Size: {position_size}, RSI: {rsi_val:.1f}")
                    ...
                    if risk_amount <= 0:
                        print(f"🌙 MOON DEV DEBUG: Invalid risk calculation for short - Entry: {entry_price}, SL: {stop_loss_price}")
                        return
                    ...
                    if position_size > 0:
                        print(f"🌙 MOON DEV SHORT ENTRY: Price: {entry_price:.2f}, Size: {position_size}, RSI: {rsi_val:.1f}")
