...
class AdaptiveTrendFlow(Strategy):
    ...
    adx_period = 10  # Quicker trend strength assessment
    volume_sma_period = 12  # Tighter volume filter
    rsi_period = 10  # Faster RSI for momentum
    risk_per_trade = 0.03  # Increased risk for higher returns
    max_drawdown_per_trade = 0.035  # Balanced risk management
    portfolio_max_drawdown = 0.1  # Allow more room for recovery
    ...
    def init(self):
        ...
        # 🌙 NEW: MACD FOR ADDITIONAL MOMENTUM CONFIRMATION
        ...
        if self.position:
            if self.position.is_long:
                ...
                exit_conditions = [
                    ...
                    adx_current < 25,  # Slightly relaxed for trend continuation
                    ...
                    macd_current < macd_signal_current and macd_previous >= macd_signal_current  # MACD cross down
                ]
                ...
                exit_conditions = [
                    ...
                    macd_current > macd_signal_current and macd_previous <= macd_signal_current  # MACD cross up
                ]
            ...
            long_conditions = [
                ...
                current_close < bb_upper_current * 0.99,  # Room to run
                macd_current > macd_signal_current,  # MACD bullish
                macd_current > macd_previous  # MACD accelerating
            ]
            ...
            short_conditions = [
                ...
                rsi_current < rsi_previous,
                current_close > bb_lower_current * 1.01,  # Room to run
                macd_current < macd_signal_current,  # MACD bearish
                macd_current < macd_previous  # MACD accelerating down
            ]
            ...
            if long_score >= 10:  # Require 10/13 conditions for premium setups
                entry_price = current_close
                stop_loss_price = entry_price - (2.0 * atr_current)  # Tighter SL for better R:R
                take_profit_price = entry_price + (5.0 * atr_current)  # Improved profit potential
            ...
            elif short_score >= 10:  # Require 10/13 conditions for premium setups
                entry_price = current_close
