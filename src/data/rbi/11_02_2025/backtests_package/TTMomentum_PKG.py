...
class TTMomentum(Strategy):
    ...
    def init(self):
        ...
        bb_bands = self.I(ta.BBANDS, self.data.Close, timeperiod=self.bb_period, nbdevup=self.bb_std, nbdevdn=self.bb_std)
        ...
        macd_result = self.I(ta.MACD, self.data.Close, fastperiod=12, slowperiod=26, signalperiod=9)
