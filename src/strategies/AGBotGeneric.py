"""
AGBot Generic Strategy - Exact copy of AGBotStrategy for optimization
...
class AGBotGeneric(Strategy):
    """
    AG Bot Trading Strategy adapted for backtesting.py
    Generic version for optimization across any ticker/timeframe
    """
    ...
    def next(self):
        ...
        # Check session time (disabled for 24/7 markets)
        if not self.in_session():
            return
        
        # Close positions at EOD (disabled for 24/7 markets)
